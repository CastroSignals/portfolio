...
export class ProjectService {
  private readonly _projects = signal<Project[]>([
    {
      ...
      description: 'Built the frontend for a revenue analytics platform used daily by 10+ airline clients. Interactive dashboards let pricing teams navigate 100,000+ documents in real time.',
      image: '',
    ...
    },
    {
      ...
      description: 'Replaced 8 separate logistics dashboards with a unified platform. Created a reusable data grid now used across 10+ company projects. Sole developer serving 2 enterprise clients and 100+ users.',
      image: '',
  ...
  private readonly _timeline = signal<TimelineItem[]>([
    ...
    },
    {
      ...
      description: 'Double degree covering algorithms, data structures, probability, statistics, linear algebra, and calculus. A quantitative foundation that shapes how I approach data visualization and complex problem-solving.',
